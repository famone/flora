    ...
    <div class="container mx-auto">
      <div class="grid grid-cols-12 gap-4">
        <div class="col-span-3">
          <ul class=" space-y-1">
            <li
              v-for="(cat, index) in store.cats"
              :key="index"
              @mouseover="changeCat(index)"
              @click="closeCatalog"
            >
              <router-link
                :to="cat.url"
              ...
              >
                ...
                <ChevronRightIcon
                  ...
                  class="h-5 absolute right-2 top-1/2 -translate-y-2.5 text-primary_2"
                />
              </router-link>
            </li>
          </ul>
        ...
        <div class="col-span-9 border-l pl-4">
          ...
          <div class="sub">
            ...
            <div class="sub-cols pb-16">
              <ul class="columns-5">
                <li
                  v-for="(group, idx) in filteredCats()"
                  :key="idx"
                  class="flex mb-2"
