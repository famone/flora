<template>
  ...
  >
    <div
      class="bg-white rounded-lg p-8 w-[400px] relative"
      @click.stop
    >
      <div
      ...
      >
        <template #after>
          <EyeIcon
            ...
            class="after-icon h-6 text-gray-400"
      ...
      <!-- <OtpInput /> -->
      <button
        class=" bg-primary rounded-xl px-4 py-4 text-white whitespace-nowrap font-bold w-full mb-4"
        @click="submitForm"
      >
        Войти
      </button>
