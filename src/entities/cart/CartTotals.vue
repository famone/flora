<template>
    <div class="rounded-xl bg-gray-100 mb-4">
        ...
        <div class="p-4 border-b border-gray-300">
            <div class="flex justify-between items-center mb-2">
                <p class="font-bold">Минимальная сумма заказа - 2 500 ₽</p>
            </div>
            <div class="flex justify-between items-center mb-2">
                <p class="text-sm">Для оформления осталось</p>
                <p class="font-bold  text-red-500">{{ leftToOrder.toLocaleString() }} ₽</p>
            </div>
        </div>
        <div class="p-4 py-6">
            <div class="flex justify-between items-center">
    ...
    <div class="bg-yellow-50 rounded-xl p-4 flex">
        ...
        <p class="text-yellow-700"> Промокод и сертификат применяется после окончательного формирования заказа в корзине!
        </p>
    </div>
</template>
