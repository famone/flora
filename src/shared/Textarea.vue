<template>
    <div class="relative">
        <label class="absolute left-3 transition-all text-gray-400 z-10 pointer-events-none"
            :class="focused ? 'text-sm top-2' : 'text-md top-5'">{{ props.placeholder }}</label>
        ...
        <textarea rows="3"
            ...
            v-model="value" @focusin="focused = true" @focusout="focusOut" @change="focusOut"></textarea>
    </div>
</template>
