<template>
    <div :class="topbar" class="bg-[url('https://sflora.ru/dist/img/submit2.a80d1d3f.jpg')]">
        <div class="container mx-auto flex justify-between relative">
            <CatalogSelect @click="catalogModalVisible = !catalogModalVisible" :catalogSelected="catalogSelected" />
            <transition name="fade-slide">
                <CatalogSelectModal v-if="catalogModalVisible" @changeCatalog="changeCatalog"
                    :catalog-selected="catalogSelected" @closeModal="closeModal" />
            </transition>
